    ...
    <div class="wrapper" id="app">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index3.html" class="brand-link">
          <img src="{{asset('img/books.png')}}" alt="bookstore Logo" class="brand-image img-circle elevation-3"
               style="opacity: .8">
        ...
        <div class="sidebar">
          ...
          <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
              <img src="{{asset('img/reading.png')}}" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
              ...
              <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item">
                 <router-link to="/dashboard" class="nav-link" tag="a" active-class="active" exact>
                   <i class="nav-icon fas fa-th text-teal"></i>
                   <p>
                     Dashboard
                   </p>
                 </router-link>
               ...
               @can('isAdmin')
                <li class="nav-item has-treeview">
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <router-link to="/users" class="nav-link" tag="a" active-class="active" exact>
